...
object SampleData {
    ...
    val products = listOf(
        Product("Pepsi 500ml", 4500, "2026-08-01", "2027-02-01"),
        Product("Mirinda 500ml", 3200, "2026-08-05", "2027-02-05"),
        Product("7UP 500ml", 2800, "2026-08-10", "2027-02-10"),
        Product("Pepsi 1.5L", 1500, "2026-08-12", "2027-02-12"),
        Product("Mountain Dew 500ml", 1900, "2026-08-15", "2027-02-15"),
    )
